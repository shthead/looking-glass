...
final class LookingGlass {
  ...
  private function render_routers() {
    ...
    print('<select size="15" class="form-control" name="routers" id="routers">');
  ...
  public function render() {
    ...
    print('<link href="libs/bootstrap-3.3.6/css/bootstrap.min.css" rel="stylesheet" />');
    if ($this->frontpage['bootstrap_theme']) {
      print('<link href="libs/bootstrap-3.3.6/css/bootstrap-theme.min.css" rel="stylesheet" />');
    }
